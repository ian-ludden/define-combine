...
def aux_graph(partition):
    ...
    for u, v in cut_edges_set:
        ...
        u_part_votes_definer = partition.votes_for_definer[u_part]
        v_part_votes_definer = partition.votes_for_definer[v_part]
        
        u_part_total_votes = partition.total_votes[u_part]
        v_part_total_votes = partition.total_votes[v_part]
